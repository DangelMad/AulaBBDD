...
String p;
    ...
    private void initComponents() {
        ...
        comboBoxTutor2 = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("BORRAR datos de tutores:");
        ...
        jLabel2.setText("MODIFICAR datos de tutores:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(comboBoxTutor2, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(109, 109, 109)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(comboBoxTutor2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnCargar)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        Tutor t = (Tutor)comboBoxTutor2.getSelectedItem();
        
        txtNombre.setText(t.getNombre());
        txtApellido.setText(t.getApellido());
        txtApellido2.setText(t.getApellido2());
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        String SQL = "UPDATE Tutores SET Nombre = '"+nombre+"', Apellido = '"+apellido+"', Apellido2 = '"+apellido2+"', Direccion = '"+direccion+"', Email = '"+email+"',"
                + "Telefono = '"+telefono+"' WHERE IdTutor= "+tutor.getIdTutor()+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarTutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrarTutor().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<Tutor> comboBoxTutor;
    private javax.swing.JComboBox<Tutor> comboBoxTutor2;
